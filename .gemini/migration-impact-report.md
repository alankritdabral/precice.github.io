...
| File | Planned Changes | Comparison | Impact on Functionality | Impact on Styling |
| :--- | :--- | :--- | :--- | :--- |
| `content/index.html` | Convert `panel` to `card`; `img-responsive` → `img-fluid`; update grid classes. | **Better**: Standardizes on the modern "Card" component. | **Low** | **Moderate**: Landing page section layouts. |
