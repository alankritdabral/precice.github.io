...
<img class="img-responsive center-block img-light" src="/images/docs/install-decision_light.png" alt="Decision tree for installation method" style="margin: auto; margin-bottom:40px" usemap="#image-map"/>
<img class="img-responsive center-block img-dark" src="/images/docs/install-decision_dark.png" alt="Decision tree for installation method" style="margin: auto; margin-bottom:40px" usemap="#image-map"/>
